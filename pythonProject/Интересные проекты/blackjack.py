...
HEARTS = "^" #"♥".encode("utf-8")#chr(9829)
DIAMONDS ="_" #"♦".encode("utf-8") #chr(9830)
SPADES = "+" #"♠".encode("utf-8")#chr(9824)
CLUBS = "*" #"♣".encode("utf-8")#chr(9827)
BLACKSIDE = 'blackside'
def main():
    print("Добро пождаловать в игру блекДжек")
    print("Правила игры: ")
    money = 5000
    while True:
        if money <= 0:
